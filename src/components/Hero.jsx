...
function Hero() {
  return (
    <section className=" text-gray-700 px-3 h-screen flex flex-col items-center justify-around relative">
      ...
      <section className="text-center">
        ...
        >
          ...
          <h2 className="text-2xl ">Desenvolvedor Web Full-Stack</h2>
        </div>
      </section>
     ...
     data-aos-duration="1000">
      <section className="flex w-full flex-col gap-2">
        ...
        <section className="flex flex-wrap w-full gap-4 px-4 justify-center items-center ">
          ...
          {/* <hr /> */}
          {/* <section className="flex flex-wrap w-full gap-4 px-4 "> */}
