...
export default function Contact() {
  return (
    <section className="text-gray-800 pt-10 px-4 flex flex-col shadow-lg items-center   relative" id="contact">
      ...
      <section className="flex text-justify justify-center mb-10 max-w-7xl flex-col items-center mt-10">
        <section
          data-aos="fade-left"
        ...
        >
          ...
          <section className="text-gray-800 pt-10  min-w-full px-4 flex flex-col gap-10 shadow-lg  items-center   relative p-5 rounded-2xl" id="contact">
